...
helm repo add mobilecoin-public https://s3.us-east-2.amazonaws.com/charts.mobilecoin.com/

# Update repo if you already have it installed
helm repo update mobilecoin-public

# Search repo for helm charts
helm search repo -l --devel --version ${VERSION} mobilecoin-public
